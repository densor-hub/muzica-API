...
const includesUpperCase=(phrase)=>{
...
const includesLowerCase=(phrase)=>{
    if(phrase===undefined || phrase===null){
        return false
    }
    else if(
...
const includesSymbols= (phrase)=>{
    if(phrase===undefined || phrase===null){
        return false
    }
    else  if(phrase.includes("~")||phrase.includes("!") || phrase.includes("@") || phrase.includes("#")|| phrase.includes("$")|| phrase.includes("%")||phrase.includes("^")
...
const includesSymbolsButPeriod= (phrase)=>{
    if(phrase===undefined || phrase===null){
        return false
    }
    else  if(phrase.includes("~")||phrase.includes("!") || phrase.includes("@") || phrase.includes("#")|| phrase.includes("$")|| phrase.includes("%")||phrase.includes("^")
...
const includesNumbers=(phrase)=>{
    if(phrase===undefined || phrase===null){
        return false
    }
    else if (String(phrase).includes("0")|| String(phrase).includes("1")|| String(phrase).includes("2")|| String(phrase).includes("3") ||  String(phrase).includes("4")
...
module.exports={includesNumbers, includesLowerCase, includesSymbolsButPeriod, includesSymbols, includesUpperCase}
